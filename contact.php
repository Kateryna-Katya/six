        ...
        <div class="container">
            ...
            <div class="contact-cards">
                <div class="legal-card">
                    ...
                    <h2 class="legal-card__title">Пишите нам</h2>
                    <p class="legal-card__text">Для общих вопросов, предложений и запросов на разработку AI-ботов:</p>
                ...
                <div class="legal-card">
                    ...
                    <h2 class="legal-card__title">Звоните</h2>
                    <p class="legal-card__text">Прямая линия экспертной поддержки и консультаций по интеграции:</p>
                    <a href="tel:+493037516204" class="contact-link">+49 30 3751 6204</a>
                </div>
                ...
                <div class="legal-card">
                    ...
                    <h2 class="legal-card__title">Наш офис</h2>
                    <p class="legal-card__text">Главный офис компании <strong><?= $domainTitle ?></strong> расположен по адресу:</p>
