            ...
            <div class="legal-content">
                <div class="legal-block agreement">
                    <p>
                        ...
                        предоставляемые пользователями <strong><?= $domainTitle ?></strong>, как для доступа к материалам по разработке AI-ассистентов, так и для других взаимодействий в электронном формате на территории Европы.
                    </p>
                </div>

                <div class="contact-extra" style="margin: 30px 0;">
                    <p>
                        <strong><?= $domainTitle ?></strong> оставляет за собой право вносить изменения в положения Политики. Обратите внимание, что наши ресурсы могут содержать ссылки на сторонние AI-сервисы и библиотеки. Предоставляя свои данные, вы даете полное согласие на их обработку способами, предусмотренными настоящей Политикой.
                    </p>
                </div>
                ...
                <div class="storage-info">
                    ...
                    <div class="storage-item">
                        ...
                        <div class="storage-text">
                            ...
                            <span>Только добровольно</span>
                        </div>
                    </div>
                </div>
                <p>
                    Для предотвращения утечки данных при работе с нейросетевыми моделями мы используем полный комплекс мер информационной безопасности. Уничтожение или блокирование данных осуществляется по запросу клиента или при достижении целей сбора (например, завершение цикла обучения).
                </p>

                <div class="data-collection-grid">
                    <div class="legal-card">
                        <div class="legal-card__icon"><i data-lucide="cpu"></i></div>
                        <h3 class="legal-card__title">Техническая информация</h3>
                        <ul class="legal-list">
                            <li>IP-адрес и логи доступа к API</li>
                            <li>Источники перехода на <strong><?= $fullDomain ?></strong></li>
                            <li>Данные браузера и паттерны взаимодействия с блоками</li>
                        </ul>
                    </div>
                    <div class="legal-card">
                        <div class="legal-card__icon"><i data-lucide="fingerprint"></i></div>
                        <h3 class="legal-card__title">Персонализация</h3>
                        <ul class="legal-list">
                            <li>Имя пользователя / Никнейм</li>
                            <li>E-mail и номер телефона (DE)</li>
                            <li>Данные о выбранных курсах и AI-инструментах</li>
                        </ul>
                    </div>
                </div>
                ...
                <ul class="legal-list">
                    <li>Предоставление доступа к передовой цифровой инфраструктуре обучения.</li>
                    <li>Учет пользовательского опыта при разработке новых AI-алгоритмов.</li>
                    <li>Информирование о стратегиях роста на базе инноваций и материалах блога.</li>
                    <li>Обеспечение оперативной экспертной поддержки по всем вопросам.</li>
                </ul>

                <h2>Использование Cookies</h2>
                <p>
                    Файлы cookie позволяют нам анализировать трафик и сохранять ваши предпочтения (например, настройки региона Германия), чтобы сделать использование платформы <strong><?= $fullDomain ?></strong> удобнее. Вы можете в любой момент изменить настройки конфиденциальности в своем браузере.
                </p>
